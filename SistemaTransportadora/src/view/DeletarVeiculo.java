...
public class DeletarVeiculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rtTitulo.setText("Digite o Código do Veículo:");
    ...
    private void deletar() {
        ...
        int codVei = Integer.parseInt(cxPesquisa.getText());
        if(con == true){
            try {
                PreparedStatement pst = banco.connection.prepareStatement("DELETE FROM veiculo WHERE codigo = "+codVei);
                pst.execute();
